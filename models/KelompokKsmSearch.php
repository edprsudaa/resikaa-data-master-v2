...
/**
 * KelompokKsmSearch represents the model behind the search form of `app\models\KelompokKsm`.
 */
class KelompokKsmSearch extends KelompokKsm
{
    /**
     * {@inheritdoc}
     */
