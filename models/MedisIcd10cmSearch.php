...
/**
 * MedisIcd10cmSearch represents the model behind the search form of `app\models\MedisIcd10cm`.
 */
class MedisIcd10cmSearch extends MedisIcd10cm
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MedisIcd10cm::find()->where(['<>', 'is_deleted', 1])->orderBy([
            // 'id' => SORT_ASC
            'id' => SORT_DESC
        ]);
