        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h5> <?= $this->title = 'Golongan Darah';?></h5>
                ...
                <div class="card-body">
                    ...
                    <?php Pjax::begin(['id'=>'golongan-darah']); ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Edit Golongan Darah</h5>
...
<div class="modal fade" id="delete-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="idGolonganDarah">
...
<script>
    ...
    $(document).on("beforeSubmit", "form#form-golongan-darah", function (e) {

        var nama = $("#nama").val();
            $.ajax({
                url: '<?php echo Url::to(['golongan-darah/create']) ?>',
                type: 'post',
                data: {
                    nama : nama
                },
    ...
    $('#btnEdit').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['golongan-darah/update']) ?>' + '?id=' + id,
            type: 'post',          
            data: {
                nama : nama,
            },
    ...
    $('#delete-modal').on('show.bs.modal', function (e) {
        var button = $(e.relatedTarget);
        var id = button.data('id'); 
        $('#idGolonganDarah').val(id);        
    });

    $('#btnDelete').click(function(e) {
        e.preventDefault();

        var id  = $('#idGolonganDarah').val();

        $.ajax({
            url: '<?php echo Url::to(['golongan-darah/delete/']) ?>' + '?id=' + id,
            type: 'post', 
            success: function(response) {
                console.log('response : ', response);
