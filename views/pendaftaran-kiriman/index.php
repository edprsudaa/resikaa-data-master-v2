...
/* @var $searchModel app\models\PendaftaranKirimanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Jenis Kiriman';
             ...
             <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="card card-outline card-primary mb-4">
                        <!-- /.card-header -->
                        <div  class="card-body">  
                            <?php Pjax::begin(['id' => 'form-kiriman']); ?>    
                                <?php $form = ActiveForm::begin(); ?>                    
                            
                                <div class="row">
                                    <div class="col">
                                        <div class="input-group ">
                                            <input type="text" name="kiriman" id="kiriman" class="form-control" placeholder="Inputkan Jenis Kiriman..." autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="table-responsive">
                                        <?php Pjax::begin(['id' => 'kiriman_pjax']); ?> 
                                            <?= GridView::widget([
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Edit Jenis Kiriman</h5>
            ...
            ?> 
                ...
                <div class="modal-body">
                    <div class="row">   
                        <div class="card-body">
                            <input type="hidden" name="id" id="id_kiriman">
...
<script>
     $('.btn-save').click(function(e){
        ...
        var nama = $("#kiriman").val();

        if (nama == "") {
            swal.fire({
                title: "Harap isi Nama Kiriman Terlebih Dahulu!",
                icon: "warning",
            });        
            ...
            $.ajax({
                url: '<?php echo Url::to(['pendaftaran-kiriman/create']) ?>',
                type: 'post',
                data: {
                    nama : nama,
                },
                success: function(response){
                    ...
                    if (response.success === true) {                    
                        ...
                        // document.getElementById("form-edit").reset();        
                         ...
                         $.pjax.reload('#kiriman_pjax, #form-kiriman', {timeout: 3000});                       
    ...
    $('#btnEdit').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['pendaftaran-kiriman/update/']) ?>' + '?id=' + id,
            type: 'post',          
            data: {
                nama     : nama,
                aktif       : aktif,
    ...
    $('#btnDelete').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['pendaftaran-kiriman/delete/']) ?>' + '?id=' + id,
            type: 'post', 
            success: function(response) {
