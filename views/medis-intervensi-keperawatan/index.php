...
/* @var $searchModel app\models\MedisIntervensiKeperawatanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Data Intervensi Keperawatan';
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h5>Data Intervensi Keperawatan</h5>
                </div>
                <div class="card-body">
                    <div class="card card-outline card-primary mb-4">
                        <!-- /.card-header -->
                        <div  class="card-body">  
                            <?php Pjax::begin(['id' => 'form-intervensi-keperawatan']); ?>    
                            <?php $form = ActiveForm::begin(); ?>                    
                           
                            <div class="row">
                                <div class="col-sm-4">
                                    <?= $form->field($model,'parent_id')->widget(Select2::className(),[
                                        'data' =>  ArrayHelper::map($intervensi_keperawatan,'id','rumpun'),
                                        'options' => [
                                            'id'=>'parent_id',
                    ...
                    <div class="card card-outline card-primary mt-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <?php Pjax::begin(['id' => 'intervensi_pjax']); ?>
                                        <?= GridView::widget([
                                            ...
                                            [
                                                ...
                                                'attribute' => 'Referensi',
                                                    'value' => function ($model){
                                                        return Helper::getIntervensiKeperawatan($model->parent_id);
                                                    },
        ...
        <div class="modal-content">
            ...
            ?> 
                ...
                <div class="modal-body">
                    <div class="row">   
                        <div class="card-body">
                            <input type="hidden" name="id" id="id_intervensi_keperawatan">
...
<script>
    $('.btn-save').click(function(e){
        ...
        if (deskripsi == "") {
            ...
            $.ajax({
                url: '<?php echo Url::to(['medis-intervensi-keperawatan/create']) ?>',
                type: 'post',
                data: {
                    parent : parent,
                    deskripsi : deskripsi
                ...
                success: function(response){
                    ...
                    if (response.success === true) {                    
                        ...
                        $.pjax.reload('#intervensi_pjax, #form-intervensi-keperawatan', {timeout: 3000});       
    ...
    $('#editModal').on('show.bs.modal', function (e) {
        ...
        $('#id_intervensi_keperawatan').val(id);    
    ...
    $('#btnEdit').click(function(e) {
        ...
        var id  = $('#id_intervensi_keperawatan').val();
        var deskripsi     = $('#deskripsi_edit').val();
        var aktif       = $('#aktif').val();
        var parent       = $('#parent_id_edit').val();

        $.ajax({
            url: '<?php echo Url::to(['medis-intervensi-keperawatan/update/']) ?>' + '?id=' + id,
            type: 'post',          
            data: {
                deskripsi: deskripsi,
                aktif    : aktif,
            ...
            success: function(response) {
                ...
                if (response.success === true) {                    
                    ...
                    $.pjax.reload('#intervensi_pjax', {timeout: 3000});                           
    ...
    $('#btnDelete').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['medis-intervensi-keperawatan/delete/']) ?>' + '?id=' + id,
            type: 'post', 
            success: function(response) {
