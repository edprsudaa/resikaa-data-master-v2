...
/* @var $searchModel app\models\SukuSearch */
           ...
           <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="card card-outline card-primary mb-4">
                        <!-- /.card-header -->
                        <div  class="card-body">  
                            <?php Pjax::begin(['id' => 'form-suku']); ?>    
                                <?php $form = ActiveForm::begin(); ?>                    
                            
                                <div class="row">
                                    <div class="col">
                                        <div class="input-group ">
                                            <input type="text" name="suku" id="suku" class="form-control" placeholder="Inputkan Nama Suku..." autocomplete="off">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Edit Suku</h5>
            ...
            ?> 
                ...
                <div class="modal-body">
                    <div class="row">   
                        <div class="card-body">
                            <input type="hidden" name="id" id="id_suku">
...
<script>
    ...
    $('.btn-save').click(function(e){
        ...
        if (suku == "") {
            swal.fire({
                title: "Harap isi Nama Suku Terlebih Dahulu!",
                icon: "warning",
            });        
            ...
            $.ajax({
                url: '<?php echo Url::to(['suku/create']) ?>',
                type: 'post',
                data: {
                    suku : suku,
                },
                success: function(response){
                    ...
                    if (response.success === true) {                    
                        ...
                        // document.getElementById("form-edit").reset();        
                         ...
                         $.pjax.reload('#suku_pjax, #form-suku', {timeout: 3000});                       
    ...
    $('#btnEdit').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['suku/update/']) ?>' + '?id=' + id,
            type: 'post',          
            data: {
                nama     : nama,
                aktif       : aktif,
    ...
    $('#btnDelete').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['suku/delete/']) ?>' + '?id=' + id,
            type: 'post', 
            success: function(response) {
