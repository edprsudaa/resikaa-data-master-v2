        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <p class="float-sm-right">
                    <?= Html::a('<i class="fas fa-plus-circle"></i> Tambah ICD-10', ['create'], [
                        'class' => 'btn btn-success',
                        'data-title' => 'Tambah ICD-10',
                        'data-toggle' => "modal",
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($model) {
                        return MedisIcd10cm2010::getOneIcd10cm2010($model->parent_id);
                    },
                    ...
                    'buttons' => [
                        'view' => function ($url, $model) {
                            ...
                            return Html::a($icon, Url::to(['view', 'id' => $model['id']]), [
                                'data-title' => 'Detail ICD-10 '. $model->kode,
                                'data-toggle' => "modal",
                                'data-target' => "#detailModal",
                            ]);
                        },
                        'update' => function ($id, $model) {
                            ...
                            return Html::a($icon, Url::to(['update', 'id' => $model['id']]), [
                                'data-title' => 'Update ICD-10 '. $model->kode,
                                'data-toggle' => "modal",
                                'data-target' => "#detailModal",
                            ]);
                        },
                        'delete' => function ($url, $model) {
                            ...
                            return Html::a($icon, $url, [
                                ...
                                'text' => "Apakah anda yakin ingin menghapus ICD-10 Kode: " . $model->kode . " ?",
