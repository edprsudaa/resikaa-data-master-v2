        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h5> <?= $this->title = 'Status Kedudukan Keluarga';?></h5>
                ...
                <div class="card-body">
                    ...
                    <?php Pjax::begin(['id'=>'status-kedudukan-keluarga']); ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Edit Status Kedudukan Keluarga</h5>
...
<div class="modal fade" id="delete-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="idStatusKedudukanKeluarga">
...
<script>
    ...
    $(document).on("beforeSubmit", "form#form-status-kedudukan-keluarga", function (e) {

        var nama = $("#nama").val();
            $.ajax({
                url: '<?php echo Url::to(['status-kedudukan-keluarga/create']) ?>',
                type: 'post',
                data: {
                    nama : nama
                },
    ...
    $('#btnEdit').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['status-kedudukan-keluarga/update']) ?>' + '?id=' + id,
            type: 'post',          
            data: {
                nama : nama,
            },
    ...
    $('#delete-modal').on('show.bs.modal', function (e) {
        var button = $(e.relatedTarget);
        var id = button.data('id'); 
        $('#idStatusKedudukanKeluarga').val(id);        
    });

    $('#btnDelete').click(function(e) {
        e.preventDefault();

        var id  = $('#idStatusKedudukanKeluarga').val();

        $.ajax({
            url: '<?php echo Url::to(['status-kedudukan-keluarga/delete/']) ?>' + '?id=' + id,
            type: 'post', 
            success: function(response) {
                console.log('response : ', response);
