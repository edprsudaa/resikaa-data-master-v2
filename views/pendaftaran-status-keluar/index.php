...
/* @var $searchModel app\models\PendaftaranStatusKeluarSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Jenis Status Keluar';
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h5>Jenis Status Keluar</h5>
                </div>
                <div class="card-body">
                    <div class="card card-outline card-primary mb-4">
                        <!-- /.card-header -->
                        <div  class="card-body">  
                            <?php Pjax::begin(['id' => 'form-status-keluar']); ?>    
                                <?php $form = ActiveForm::begin(); ?>                    
                            
                               <div class="row">
                                    <div class="col">
                                        <div class="input-group ">
                                            <input type="text" name="statusKeluar" id="statusKeluar" class="form-control" placeholder="Inputkan Status Jenis Keluar..." autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="table-responsive">
                                        <?php Pjax::begin(['id' => 'status_keluar_pjax']); ?>
                                            <?= GridView::widget([
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Edit Jenis Status Keluar</h5>
            ...
            ?> 
                ...
                <div class="modal-body">
                    <div class="row">   
                        <div class="card-body">
                            <input type="hidden" name="id" id="id_status_keluar">
...
<script>
     $('.btn-save').click(function(e){
        ...
        var nama = $("#statusKeluar").val();

        if (nama == "") {
            swal.fire({
                title: "Harap isi Nama Jenis Status Keluar Terlebih Dahulu!",
                icon: "warning",
            });        
            ...
            $.ajax({
                url: '<?php echo Url::to(['pendaftaran-status-keluar/create']) ?>',
                type: 'post',
                data: {
                    nama : nama,
                },
                success: function(response){
                    ...
                    if (response.success === true) {                    
                        ...
                        $.pjax.reload('#status_keluar_pjax, #form-status-keluar', {timeout: 3000});                       
    ...
    $('#btnEdit').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['pendaftaran-status-keluar/update/']) ?>' + '?id=' + id,
            type: 'post',          
            data: {
                nama     : nama,
                aktif       : aktif,
    ...
    $('#btnDelete').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['pendaftaran-status-keluar/delete/']) ?>' + '?id=' + id,
            type: 'post', 
            success: function(response) {
