...
$this->title = 'Medis Icd 10cm 2010';
                        ...
                        <div class="col-sm-6">
                            <p class="float-sm-right">
                                <?php 
                                    Modal::begin([
                                        'id'    => 'addModal',
                                        'title' => 'Form Tambah ICD 10',
                                        'size'  => 'modal-lg',
                                        'toggleButton' => ['label' => '+ Tambah ICD 10', 'class' => 'btn btn-success'],
                                    ]);
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editlabel" data-backdrop="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Edit ICD 10</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
             ...
             <div class="modal-body">
                <div class="row">
                    <div class="card-body">
                        <?php $form = ActiveForm::begin(['id'=> 'form-icd-10-edit','options' => ['data-pjax' => true ]]); ?>
...
<script>
    $('.btn-submit').click(function(e){
        ...
        if (kode == "") {
            ...
            $.ajax({
                url: '<?php echo Url::to(['medis-icd-10cm2010/create']) ?>',
                type: 'post',
                data: {
                    kode : kode,
                    deskripsi : deskripsi,
                ...
                success: function(response){
                    ...
                    if (response.success === true) {                    
                        ...
                        $('#addModal').modal('hide');  
                        $("#form-icd-10").trigger("reset"); 
                        $.pjax.reload('#icd-10-pjax', {timeout:3000});                         
                    ...
                    //     $("#form-icd-10").trigger("reset"); 
                    //     $.pjax.reload('#icd_10_pjax',{timeout:3000});   
    ...
    $('#deleteBtn').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['medis-icd-10cm2010/delete/']) ?>' + '?id=' + id,
            type: 'post', 
            success: function(response) {
    ...
    $('.btn-edit').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['medis-icd-10cm2010/update']) ?>' + '?id=' + id,
            type: 'post',          
            data: {
                kode : kode,
                deskripsi: deskripsi,
            ...
            success: function(response) {
                ...
                if (response.success === true) {                    
                    ...
                    $('#editModal').modal('hide');                                 
                    $.pjax.reload('#icd-10-pjax, #form-icd-10-edit', {timeout:3000});   
