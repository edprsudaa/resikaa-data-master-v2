...
$this->title = 'Kategori Dokter';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="kategori-dokter-index container-fluid">    
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div  class="card-body">   
                        <?php $form = ActiveForm::begin([
                            'id' => 'form-kategori-dokter',
                            'action' => ['kategori-dokter/create'],
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-group">
                                    <input type="text" name="nama" id="kategoriDokter" class="form-control" placeholder="Inputkan Kategori Dokter..." autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="table-responsive">
                                        <?php Pjax::begin(['id' => 'kategori_dokter_pjax']); ?> 
...
<?php Modal::begin([
    'id' => 'updateModal',
    'title' => 'Ubah Kategori Dokter',
]); ?>
    <form id="form-update-kategori-dokter">
...
<?php
$saveUrl = Url::to(['kategori-dokter/create']);
$updateUrl = Url::to(['kategori-dokter/update']);
$deleteUrl = Url::to(['kategori-dokter/delete']);
$js = <<<JS
...
$(document).on('click', '.btn-save', function (e) {
    ...
    let nama = $("#kategoriDokter").val().trim();
    if (nama === "") {
        showToast('warning', 'Harap isi Nama Kategori Dokter terlebih dahulu!');
        $("#kategoriDokter").focus();
        return;
    }
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.success) {
                ...
                form.trigger("reset");
                $.pjax.reload({container: '#kategori_dokter_pjax', timeout: 3000});
            } else {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $.pjax.reload('#kategori_dokter_pjax', { timeout: 3000 });
                    } else {
