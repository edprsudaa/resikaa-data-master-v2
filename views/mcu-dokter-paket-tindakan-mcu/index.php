...
/* @var $searchModel app\models\McuDokterPaketTindakanMcuSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Mcu Dokter Paket Tindakan MCU';
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <p class="float-sm-right">
                                <?php 
                                    Modal::begin([
                                        'id'    => 'addModal',
                                        'title' => 'Form Tambah Paket Tindakan MCU Dokter',
                                        'size'  => 'modal-lg',
                                        'toggleButton' => ['label' => '+ Tambah Paket Tindakan MCU Dokter', 'class' => 'btn btn-success'],
                                    ]);
                    ...
                    <div class="row">
                        <div class="col-12">
                            <?php Pjax::begin(['id'=>'paket-tindakan-mcu-dokter']); ?>
...
<script>
    ...
    $('#deleteBtn').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['mcu-dokter-paket-tindakan-mcu/delete/']) ?>' + '?id=' + id,
            type: 'post', 
            success: function(response) {
                ...
                if (response.success === true) {                    
                   ...
                   $.pjax.reload('#paket-tindakan-mcu-dokter', {timeout:3000});   
...
<!-- <div class="mcu-dokter-paket-tindakan-mcu-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Create new Mcu Dokter Paket Tindakan Mcus','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Mcu Dokter Paket Tindakan Mcus listing',
