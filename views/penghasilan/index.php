        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h5> <?= $this->title = 'Data Penghasilan';?></h5>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Edit Penghasilan</h5>
...
<div class="modal fade" id="delete-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="idPenghasilan">
...
<script>
    ...
    $(document).on("beforeSubmit", "form#form-penghasilan", function (e) {

        var nama = $("#nama").val();
            $.ajax({
                url: '<?php echo Url::to(['penghasilan/create']) ?>',
                type: 'post',
                data: {
                    nama : nama
                },
    ...
    $('#btnEdit').click(function(e) {
        ...
        $.ajax({
            url: '<?php echo Url::to(['penghasilan/update']) ?>' + '?id=' + id,
            type: 'post',          
            data: {
                nama : nama,
            },
            success: function(response) {
                ...
                if (response.status === 200) {                    
                    ...
                    $.pjax.reload('#penghasilan',{timeout:3000});   
    ...
    $('#delete-modal').on('show.bs.modal', function (e) {
        var button = $(e.relatedTarget);
        var id = button.data('id'); 
        $('#idPenghasilan').val(id);        
    });

    $('#btnDelete').click(function(e) {
        e.preventDefault();

        var id  = $('#idPenghasilan').val();

        $.ajax({
            url: '<?php echo Url::to(['penghasilan/delete/']) ?>' + '?id=' + id,
            type: 'post', 
            success: function(response) {
                console.log('response : ', response);
